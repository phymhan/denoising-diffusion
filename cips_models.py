...
from cips_blocks import ConstantInput, LFF, StyledConv, ToRGB, PixelNorm, EqualLinear, StyledResBlock
from cips_blocks import ConLinear
# from model import TimeEmbedding, Swish, linear
...
class CIPSskip(nn.Module):
    def __init__(self, size=256, hidden_size=512, n_mlp=8, style_dim=512, lr_mlp=0.01,
        ...
        self.emb = ConLinear(3, hidden_size, is_first=True)
    ...
    def forward(self,
        ...
        # x = torch.cat([x, emb], 1)
        x = torch.cat([coord_emb, input_emb], 1)
